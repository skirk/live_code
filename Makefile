...
$(PROJECT): src/core.cpp obj/gl_core_3_3.o
	$(CXX) -Wall -g $(INCLUDEPATH) $(LDFLAGS) src/core.cpp obj/gl_core_3_3.o -o $@
...
shadercompiler:  obj/gl_core_3_3.o obj/shadercompiler.o obj/glslprogram.o
